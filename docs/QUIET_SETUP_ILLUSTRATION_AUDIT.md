...
| ambient-room-lighting-for-eye-comfort | Ambient room lighting for eye comfort | lighting | room-lighting-1200.jpg | **no** | Identical drawing to `lamp-light` (a single desk lamp). Expected bias / room light around a monitor, not a lamp. |
| anti-glare-screen-film-for-gaming-light | Anti-glare screen film for gaming light | screens-and-stands | screen-film-1200.jpg | **no** | Identical drawing to `monitor-calibration` (monitor + two bars). No film, peel, or matte overlay. |
...
| desk-chair-posture-for-long-quiet-sessions | Desk chair posture for long quiet sessions | desk-and-comfort | chair-posture-1200.jpg | **no** | Side-on lounge chaise / recliner. Not a desk chair and not a posture study. |
...
| large-monitor-vs-dual-monitors-for-browser-games | Large monitor versus dual monitors for browser games | screens-and-stands | screens-stands-1200.jpg | **no** | Tablet and phone stands. The file is correct for the stand article; this article is a **reference bug**. Needs its own monitor comparison, not a retouch of the stand art. |
...
## Planned fixes (next commits)

1. `ambient-room-lighting-for-eye-comfort` — regenerate `room-lighting` as bias / room light behind a monitor.
2. `anti-glare-screen-film-for-gaming-light` — regenerate `screen-film` as a monitor with a matte film applied.
3. `desk-chair-posture-for-long-quiet-sessions` — regenerate `chair-posture` as a desk chair with upright seated posture.
...
Generation will use programmatic SVG composition in the Quiet Setup charcoal / teal / amber / slate palette, rasterized at 800×450, 1200×675, and 1600×900 in WebP and JPEG. No AI-generated rasters. No embedded words.
