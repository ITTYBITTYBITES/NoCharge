...
All packages are original Quiet Arcade work. Raster covers are reproducible with `npm run art:memory`, `npm run art:word`, `npm run art:color`, and `npm run art:shattered`; gameplay screenshots are captures of the actual game DOM. JPEG social cards are used for Open Graph, Twitter, and structured data.
...
| shattered-foil / `controls-diagram.svg` | vector | 1.5 KB |
| shattered-foil / `cover-landscape.jpg` | 1280×720 | 21.4 KB |
| shattered-foil / `cover-landscape.webp` | 1280×720 | 53.7 KB |
| shattered-foil / `cover-square.jpg` | 800×800 | 14.8 KB |
| shattered-foil / `cover-square.webp` | 800×800 | 45.8 KB |
| shattered-foil / `guide-header.jpg` | 1280×640 | 20.6 KB |
| shattered-foil / `guide-header.webp` | 1280×640 | 47.0 KB |
| shattered-foil / `icon.svg` | vector | 0.3 KB |
| shattered-foil / `rules-diagram.svg` | vector | 1.5 KB |
| shattered-foil / `screenshot-desktop.webp` | 1440×900 | 28.7 KB |
| shattered-foil / `screenshot-mobile.webp` | 720×1280 | 23.7 KB |
| shattered-foil / `social-card.jpg` | 1200×630 | 20.5 KB |
| shattered-foil / `social-card.webp` | 1200×630 | 44.9 KB |
| shattered-foil / `source.svg` | vector | 2.8 KB |
