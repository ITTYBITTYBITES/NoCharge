...
| Quiet Setup index and eight launch guides | Evidence labels, topic criteria, disclosures, paid-link destinations | `src/content/setup/`, setup components, affiliate config and validator | Article/link/policy or evidence change | Editorial + affiliate compliance | 2026-08-21 | All launch evidence is editorial research; no category routes |
| Quiet Setup feed and dedicated sitemap | Published setup collection and canonical routes | `src/pages/setup/feed.xml.ts`, `src/pages/sitemap-setup.xml.ts` | Setup publish/draft/route change | SEO + feed validation | 2026-08-21 | Feed has no merchant content or trackers |
