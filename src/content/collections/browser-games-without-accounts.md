...
games:
  - game: memory-match
    reason: "The card board opens without registration, and high results plus best completed moves remain in this browser only."
  - game: word-tile-rush
    reason: "The letter grid starts without a profile, and its best score is retained only by the current browser when storage is available."
  - game: color-flip
