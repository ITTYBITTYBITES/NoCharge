...
inclusionMethod: "Include a current game when two people can complete its full play loop on one shared screen by taking turns, with no account, no network play, and no computer opponent."
reviewed: "2026-08-22"
order: 5
draft: false
games:
  - game: tic-tac-toe
    reason: "Two players complete 3×3, 4×4, or first-to-3 match rounds on one screen, with the handoff screen tracking whose move it is."
  - game: dots-and-boxes
    reason: "Both players draw lines and claim boxes on one shared board; completing a box grants the same player another line by rule."
  - game: four-in-a-row
    reason: "Players alternate dropping discs into the shared 7×6 or 6×5 board until one line of four completes the game."
  - game: reversi
    reason: "Black and white take turns outflanking on one 8×8 board, with automatic passes when a player has no legal move."
  - game: last-token
