export type SoundName = 'move' | 'place' | 'win' | 'lose' | 'merge' | 'flip' | 'hint' | 'tick' | 'error' | 'claim' | 'match' | 'step' | 'pop' | 'blip';
...
export const SOUND_BANK: Record<SoundName, SoundSpec> = {
  ...
  match: { frequencies: [520, 660], duration: .12, attack: .01, release: .09, waveform: 'sine' },
  step: { frequencies: [280], duration: .06, attack: .006, release: .04, waveform: 'sine' },
};
